...
define('PLUGIN_FILES', 'posts.php,search.php,pmsnew.php,upfiles.php,AP_Upload.php');
...
<?php
	...
	{
		if (substr($entry, -4) == '.php' && substr($entry, 0, 5) != 'admin' && !in_array($entry, array('db_update.php', 'install.php', 'extern.php', 'pjq.php', 're.php', 'footer.php', 'header.php', 'help.php', 'login.php', 'misc.php', 'register.php', 'reglog.php', 'memberslist.php')))
			$ar_file[] = $entry;
	}
	$d->close();
