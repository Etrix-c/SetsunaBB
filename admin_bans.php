...
?>
				<tr>
					...
					<td class="tc6"><?php echo ($ban_data['ban_creator_username'] != '') ? '<a href="showuser.php?id='.$ban_data['ban_creator'].'">'.pun_htmlspecialchars($ban_data['ban_creator_username']).'</a>' : $lang_admin_bans['Unknown'] ?></td>
