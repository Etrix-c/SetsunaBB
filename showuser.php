...
if ($action === 'change_pass')
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		redirect('showuser.php?section=essentials&amp;id='.$id, $lang_profile['Pass updated redirect']);
	}
...
<div class="blockform">
	...
	<div class="box">
		<form id="change_pass" method="post" action="showuser.php?action=change_pass&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
			<div class="inform">
	...
	else if (isset($_POST['form_sent']))
	{
		...
		if (is_banned_email($new_email))
		{
			...
			else if ($pun_config['o_mailing_list'] != '')
			{
				...
				$mail_message = str_replace('<profile_url>', get_base_url().'/showuser.php?id='.$id, $mail_message);
		...
		$mail_message = str_replace('<activation_url>', get_base_url().'/showuser.php?action=change_email&id='.$id.'&key='.$new_email_key, $mail_message);
		$mail_message = str_replace('<board_mailer>', $pun_config['o_board_title'], $mail_message);
...
<div class="blockform">
	...
	<div class="box">
		<form id="change_email" method="post" action="showuser.php?action=change_email&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
...
// Visman - auto resize avatar
		...
		redirect('showuser.php?section=personality&amp;id='.$id, $lang_profile['Avatar upload redirect']);
	}
...
<div class="blockform">
	...
	<div class="box">
		<form id="upload_avatar" method="post" enctype="multipart/form-data" action="showuser.php?action=upload_avatar2&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
...
else if ($action === 'delete_avatar')
{
	...
	redirect('showuser.php?section=personality&amp;id='.$id, $lang_profile['Avatar deleted redirect']);
}
...
else if (isset($_POST['update_group_membership']))
{
	...
	redirect('showuser.php?section=admin&amp;id='.$id, $lang_profile['Group membership redirect']);
}
...
else if (isset($_POST['update_forums']))
{
	...
	redirect('showuser.php?section=admin&amp;id='.$id, $lang_profile['Update forums redirect']);
}
...
<div class="blockform">
	...
	<div class="box">
		<form id="confirm_del_user" method="post" action="showuser.php?id=<?php echo $id ?>">
			<div class="inform">
				<input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" />
				<fieldset>
...
// New PMS - Visman
	...
	redirect('showuser.php?section='.$section.'&amp;id='.$id, $lang_profile['Profile redirect']);
}
	...
	if (!$section || $section == 'essentials')
	{
		...
		else
		{
			...
			if ($pun_config['o_regs_verify'] == '1')
				$email_field = '<p>'.sprintf($lang_profile['Email info'], pun_htmlspecialchars($user['email']).' - <a href="showuser.php?action=change_email&amp;id='.$id.'">'.$lang_profile['Change email'].'</a>').'</p>'."\n";
			else
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile1" method="post" action="showuser.php?section=essentials&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
				<div class="inform">
					<fieldset>
...
<?php if ($pun_user['id'] == $id || $pun_user['g_id'] == PUN_ADMIN || ($user['g_moderator'] == '0' && $pun_user['g_mod_change_passwords'] == '1')): ?>							<p class="actions"><span><a href="showuser.php?action=change_pass&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Change pass'] ?></a></span></p>
<?php endif; ?>						</div>
					</fieldset>
				</div>
				<div class="inform">
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile2" method="post" action="showuser.php?section=personal&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile3" method="post" action="showuser.php?section=messaging&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
<?php
	...
	else if ($section == 'personality')
	{
		...
		$avatar_field = '<span><a href="showuser.php?action=upload_avatar&amp;id='.$id.'">'.$lang_profile['Change avatar'].'</a></span>';

		$user_avatar = generate_avatar_markup($id);
		if ($user_avatar)
			$avatar_field .= ' <span><a href="showuser.php?action=delete_avatar&amp;id='.$id.'&amp;csrf_hash='.csrf_hash().'">'.$lang_profile['Delete avatar'].'</a></span>';
		else
			$avatar_field = '<span><a href="showuser.php?action=upload_avatar&amp;id='.$id.'">'.$lang_profile['Upload avatar'].'</a></span>';
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile4" method="post" action="showuser.php?section=personality&amp;id=<?php echo $id ?>">
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile5" method="post" action="showuser.php?section=display&amp;id=<?php echo $id ?>">
				<div><input type="hidden" name="form_sent" value="1" /><input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" /></div>
<?php
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile6" method="post" action="showuser.php?section=privacy&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile7" method="post" action="showuser.php?section=admin&amp;id=<?php echo $id ?>">
				<div class="inform">
					<input type="hidden" name="form_sent" value="1" />
					<input type="hidden" name="csrf_hash" value="<?php echo csrf_hash() ?>" />
					<fieldset>
