...
// START Quick language switching - Visman
...
// END Quick language switching - Visman
...
if ($pun_config['o_quickjump'] == '1')
{
	...
	$page_js['c'][] = 'if (document.getElementById("qjump")) document.getElementById("qjump").getElementsByTagName("div")[0].getElementsByTagName("input")[0].style.display = "none";'; // Visman - Hide the navigation button when js is enabled
}

echo $lang_temp; // Quick language switching - Visman
echo "\t\t\t".'</div>'."\n";
...
?>
				<p id="poweredby"><?php printf($lang_common['Powered by'], '<a href="https://github.com/Etrix-c/SetsunaBB">SetsunaBB</a>'.(($pun_config['o_show_version'] == '1') ? ' '.$pun_config['o_cur_version'] : '')) ?></p>
			</div>
