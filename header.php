...
if ($pun_user['g_read_board'] == '1' && $pun_user['g_view_users'] == '1')
	$links[] = '<li id="navuserlist"'.((PUN_ACTIVE_PAGE == 'userlist') ? ' class="isactive"' : '').'><a href="memberslist.php">'.$lang_common['User list'].'</a></li>';
...
{
	$links[] = '<li id="navprofile"'.((PUN_ACTIVE_PAGE == 'profile') ? ' class="isactive"' : '').'><a href="showuser.php?id='.$pun_user['id'].'">'.$lang_common['Profile'].'</a></li>';
// New PMS
