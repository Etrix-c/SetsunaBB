...
require PUN_ROOT.'include/subforums.php'; // MOD subforums - Visman
...
if ($pun_user['g_view_users'] == '1')
	$stats['newest_user'] = '<a href="showuser.php?id='.$stats['last_user']['id'].'">'.pun_htmlspecialchars($stats['last_user']['username']).'</a>';
else
