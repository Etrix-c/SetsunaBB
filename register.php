	...
	if (empty($errors))
	{
		...
		if ($pun_config['o_mailing_list'] != '')
		{
			...
			if ($banned_email)
			{
				...
				$mail_message = str_replace('<profile_url>', get_base_url().'/showuser.php?id='.$new_uid, $mail_message);
			...
			if ($pun_config['o_regs_report'] == '1')
			{
				...
				$mail_message = str_replace('<profile_url>', get_base_url().'/showuser.php?id='.$new_uid, $mail_message);
				$mail_message = str_replace('<admin_url>', get_base_url().'/showuser.php?section=admin&id='.$new_uid, $mail_message);
				$mail_message = str_replace('<board_mailer>', $pun_config['o_board_title'], $mail_message);
