...
// Load the memberslist.php language file
require PUN_ROOT.'lang/'.$pun_user['language'].'/memberslist.php';
...
$paging_links = '<span class="pages-label">'.$lang_common['Pages'].' </span>'.paginate($num_pages, $p, 'memberslist.php?username='.urlencode($username).'&amp;show_group='.$show_group.'&amp;sort_by='.$sort_by.'&amp;sort_dir='.$sort_dir);
$link_for_title = 'memberslist.php?username='.urlencode($username).'&amp;show_group='.$show_group.'&amp;'.(($p>1) ? 'p='.$p.'&amp;' : '').'sort_by=';
...
<div class="blockform">
	...
	<div class="box">
		<form id="userlist" method="get" action="memberslist.php">
			<div class="inform">
				<fieldset>
...
?>
				<tr>
					<td class="tcl"><?php echo '<a href="showuser.php?id='.$user_data['id'].'">'.pun_htmlspecialchars($user_data['username']).'</a>' ?></td>
