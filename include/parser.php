...
function do_bbcode(string $text, bool $is_signature = false)
{
	...
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/posts.php?id='.$matches[1]); };
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/posts.php?id='.$matches[1], $matches[2]); };
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/posts.php?pid='.$matches[1].'#p'.$matches[1]); };
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/posts.php?pid='.$matches[1].'#p'.$matches[1], $matches[2]); };
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/forums.php?id='.$matches[1]); };
	$replace_callback[] = function($matches) { return handle_url_tag(get_base_url(true).'/forums.php?id='.$matches[1], $matches[2]); };
