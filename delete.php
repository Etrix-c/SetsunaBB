...
if (isset($_POST['delete']))
{
	...
	if ($is_topic_post)
	{
		...
		redirect('forums.php?id='.$cur_post['fid'], $lang_delete['Topic del redirect']);
	}
	else
	{
		...
		redirect('posts.php?pid='.$post_id.'#p'.$post_id, $lang_delete['Post del redirect']);
	}
}
...
<div class="linkst">
	<div class="inbox">
		<ul class="crumbs">
			...
			<li><span>»&#160;</span><a href="posts.php?pid=<?php echo $id ?>#p<?php echo $id ?>"><?php echo pun_htmlspecialchars($cur_post['subject']) ?></a></li>
